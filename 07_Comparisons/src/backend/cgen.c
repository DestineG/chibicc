 ...
 * @param reg1 第一个操作数寄存器索引
 * @param reg2 第二个操作数寄存器索引
 * @param how 比较操作符 (e.g., "sete", "setne")
 * @return 结果寄存器索引 reg2
 */
...
int cgequal(int reg1, int reg2) {
  return cgcompare(reg1, reg2, "sete");
}
...
int cgnotequal(int reg1, int reg2) {
  return cgcompare(reg1, reg2, "setne");
}
...
int cglessthan(int reg1, int reg2) {
  return cgcompare(reg1, reg2, "setl");
}
...
int cggreaterthan(int reg1, int reg2) {
  return cgcompare(reg1, reg2, "setg");
}
...
int cglessequal(int reg1, int reg2) {
  return cgcompare(reg1, reg2, "setle");
}
...
int cggreaterequal(int reg1, int reg2) {
  return cgcompare(reg1, reg2, "setge");
}
